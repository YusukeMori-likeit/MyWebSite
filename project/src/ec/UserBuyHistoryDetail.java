	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			int buy_id = Integer.parseInt(request.getParameter("buy_id"));
	         ...
	         List<BuyDataBeans> buyDataBeansList1 = buyDao.findBuyDataAll1(buy_id);

	            request.setAttribute("buyDataBeansList1", buyDataBeansList1);



	         List<ItemDataBeans> buyDetailItemList = BuyDetailDAO.getItemDataBeansListByBuyId(buy_id);
